...
Good news, Overleaf users! After several weeks of beta testing, the new source editor (CodeMirror 6) is now available to power Overleaf. This new editor is more modern and supports a wide range of features that the old one did not. Overleaf's team is always committed to giving you the best experience possible with Overleaf, and this change is a crucial part of that mission. Be sure to read Overleaf's [latest update](https://www.overleaf.com/blog/towards-the-future-a-new-source-editor) in their blog!
