...
Jump to the section, for [getting started](#getting-started). 

TODO: COOL PICTURE

## Why use CiteDrive with Overleaf?
CiteDrive is a reference manager that focuses on BibTeX, making it quick and simple to organize your references. If you work in LaTeX, CiteDrive offers a streamlined solution for managing your bibliographies and citations. What does this imply? A CiteDrive project assists you in framing a story around each subject you work on. This is especially useful if you work with multiple teams on various tasks. The CiteDrive project's BibTeX file is automatically updated when you or your teammates add, change, or remove a new reference. This means that if you link a CiteDrive project to an Overleaf project, the Overleaf bibliography can be refreshed without you having to manually enter new entries.
...
## Step 1 Create a CiteDrive account and add some references

First, sign up for a CiteDrive account (it’s free!) and create your first Overleaf-type project

Install the CiteDrive Companion plugin appropriate for your browser:  
...
Head over to Google Scholar, Pubmed, or another academic research site and collect your reference or two


## Step 2

Head to Overleaf and start authoring a paper (or open an existing one)

Connect your paper and CiteDrive project

## Step 3

Click Insert Citation at the top of the editing screen to insert your first in-text citation
